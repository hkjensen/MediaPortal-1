    ...
    */
    ...
    private void RefreshMissingCovers(object sender, DoWorkEventArgs e)
    {
      ...
      foreach (IMDBMovie movie in movies)
      {
        ...
        // Update database with new cover
        UpdateActiveMovieImageAndThumbs(movie.ThumbURL, movie.ID,movie.IMDBNumber, movie.Title);
    ...
    private void buttonImportNfo_Click(object sender, EventArgs e)
    {
      ...
      if (tbImportNFOs.TextLength == 0)
      {
          ...
          {
              tbImportNFOs.Text = fBrowser.SelectedPath;
          }
      }
      _nfoFiles = new ArrayList();
      GetNfoFiles(tbImportNFOs.Text, ref _nfoFiles);
